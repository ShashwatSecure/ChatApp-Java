...
public class Server implements ActionListener
{
    ...
    Server()
    {
        ...
        morevert.setBounds(415,20,10,30);
        p1.add(morevert);
        ...
        //chatting area : which shows all the chats
        a1 = new JPanel();
    ...
    public static JPanel formatLabel(String out)
    {
        ...
        output.setBackground(new Color(184,255,144));
    ...
    public static JPanel formatLabels(String out)
    {
        JPanel panel = new JPanel();
